...
namespace EthanLibrary.Web.CacheManage.Memcached
{
    internal class LogAdapter
    {
        ...
        {
            Console.Out.WriteLine(DateTime.Now + " DEBUG " + loggerName + " - " + message);
        }

        public void Info(string message)
        {
            Console.Out.WriteLine(DateTime.Now + " INFO " + loggerName + " - " + message);
        }

        public void Warn(string message)
        {
            Console.Out.WriteLine(DateTime.Now + " WARN " + loggerName + " - " + message);
        }
        ...
        {
            Console.Out.WriteLine(DateTime.Now + " FATAL " + loggerName + " - " + message);
        }
