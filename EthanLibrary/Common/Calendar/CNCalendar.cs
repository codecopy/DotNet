...
namespace EthanLibrary.Common
{
    public class CNCalendar
    {
        ...
        /// 农历月份信息
        /// </summary>
        private static int[] lunarInfo = new int[]{0x04bd8,0x04ae0,0x0a570,0x054d5,0x0d260,0x0d950,0x16554,0x056a0,0x09ad0,0x055d2,
        ...
        /// 农历月份名字
        /// </summary>
        private static string[] cMonthName = new string[] { "", "正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月" };
        ...
        //公历月份名称
        private static string[] monthName = new string[] { "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" };
        ...
        /// 节气对应数值？
        /// </summary>
        private static int[] solarTermInfo = new int[] {0,21208,42467,63836,85337,107014,128867,150921,173149,195551,218072
        ...
        #endregion 传出y年m月d日对应的农历 [0].year [1].month [2].day2 [3].yearCyl [4].monCyl [5].dayCyl [6].isLeap

        #endregion 得到农历日期、年月日的天干地址及是否闰月
